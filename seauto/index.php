...
function selectRole(rol) {
  ...
  if (rol === 'admin') {
    ...
    document.getElementById('label-sifre').textContent = 'Telefon Numarası';
    document.getElementById('login-form-sub').textContent = 'E-posta ve telefon numaranızla giriş yapın';
...
async function loadLoginStats() {
  // Kamuya açık istatistik (giriş yapılmadan önce göstermek için basit endpoint)
  // Burada sadece placeholder gösteriyoruz, DB'ye bağlı değil
}
